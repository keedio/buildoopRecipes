...
%define elasticsearch_version 5.4.1
%define elasticsearch_base_version 5.4.1
%define elasticsearch_release 2.0.0%{?dist}
...
%dir /usr/lib/elasticsearch
/usr/lib/elasticsearch/*
%dir /usr/lib/elasticsearch/plugins
...
%attr(0755,rot,root) /usr/lib/sysctl.d/elasticsearch.conf
