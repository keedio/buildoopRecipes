...
#TARGET_RELEASE=target/releases/elasticsearch-5.4.1.tar.gz
TARGET_RELEASE=distribution/tar/build/distributions/elasticsearch-5.4.0.tar.gz
#SHARE_DIR=${SHARE_DIR:-/usr/lib/elasticsearch}
SHARE_DIR=${SHARE_DIR:-usr/share/elasticsearch}
#SRC=${BUILD_DIR}/working/elasticsearch.git
SRC=${BUILD_DIR}/working/elasticsearch-5.4.0
