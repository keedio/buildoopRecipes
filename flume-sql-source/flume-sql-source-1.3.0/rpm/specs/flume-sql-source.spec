...
%define flume_sql_src_base_version 1.3.0
%define flume_sql_src_release openbus_1.2.7
...
Name: flume-sql-source
Version: %{flume_sql_src_base_version}
...
BuildArch: noarch
License: APL2
Source0: flume-ng-sql-source.git.tar.gz
Source1: rpm-build-stage
Source2: install-flume-sql-source.sh
Requires: flume
...
%prep
%setup -n flume-ng-sql-source.git
