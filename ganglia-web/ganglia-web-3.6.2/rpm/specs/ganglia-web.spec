...
#%define vargwebdir /var/www/html/ganglia-web
%define vargwebdir /var/lib/ganglia-web
%define etcdir /etc/httpd/conf.d
%define varapacheuser apache
...
%__mkdir -p $RPM_BUILD_ROOT/%{etcdir}
%__mkdir -p $RPM_BUILD_ROOT/%{vargwebdir}
...
%__cp -f %{SOURCE1} $RPM_BUILD_ROOT%{etcdir}/
...
%{etcdir}
%config(noreplace) %{etcdir}/ganglia.conf
...
#TODO --> Meter la configuracion de Apache
#%triggerin -- httpd
