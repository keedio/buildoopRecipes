...
%define kafka_release openbus_1.1.3
...
getent passwd kafka > /dev/null || useradd -c "Kafka" -s /sbin/nologin -g kafka -r -d %{kafka_user_home} kafka 2> /dev/null || :
...
%__install -d -o kafka -g kafka -m 0755 %{kafka_user_home}
