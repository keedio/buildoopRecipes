...
%define spark_version 2.1.1
%define hadoop_version 2.7.3
%define spark_base_version 2.1.1
%define spark_release 2.0.0%{?dist}
...
%post
%{alternatives_cmd} --install /usr/lib/spark/default spark  /usr/lib/spark/%{name}-%{spark_base_version}-bin-%{hadoop_version} 33
