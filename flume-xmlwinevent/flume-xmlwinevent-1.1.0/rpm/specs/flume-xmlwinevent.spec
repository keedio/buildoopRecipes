...
%define flume_xmlwinevent_release openbus_1.2.2
...
Name: flume-xmlwinevent
Version: %{flume_xmlwinevent_base_version}
...
BuildArch: noarch
License: APL2
Source0: XMLWinEvent.git.tar.gz
Source1: rpm-build-stage
Source2: install-flume-xmlwinevent.sh 
Requires: flume
