...
%define flume_taildir_base_version 1.0.0
%define flume_taildir_release openbus_1.2.0
...
Name: flume-taildir
Version: %{flume_taildir_base_version}
...
BuildArch: noarch
License: APL2
Source0: flume-taildirectory-source.git.tar.gz
Source1: rpm-build-stage
Source2: install_flume-taildir.sh
Requires: flume
...
%prep
%setup -n flume-taildirectory-source.git
