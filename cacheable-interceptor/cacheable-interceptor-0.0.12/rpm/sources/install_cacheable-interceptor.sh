...
PLUGIN_DIR=/usr/lib/flume/plugins.d/cacheable
...
cp ${BUILD_DIR}/target/flume-cacheable-interceptor*.jar ${PREFIX}/${PLUGIN_LIB_DIR}
#cp ${BUILD_DIR}/target/libs/*.jar ${PREFIX}/${PLUGIN_LIBEXT_DIR}

install -d -m 0755 ${PREFIX}/${FLUME_CONF}
cp ${RPM_SOURCE_DIR}/cacheable-interceptor.conf.example ${PREFIX}/${FLUME_CONF}
