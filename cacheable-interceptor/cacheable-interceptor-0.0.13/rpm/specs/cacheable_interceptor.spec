...
%define cacheable_interceptor_base_version 0.0.13
%define cacheable_interceptor_release 2.0.0%{?dist}
...
BuildArch: noarch
License: APL2
Source0: CacheableInterceptor.git.tar.gz
Source1: rpm-build-stage
Source2: install_cacheable-interceptor.sh 
Requires: flume 
Requires: flume-enrichment-interceptor
