...
#
%define flume_base_version 1.6.0
%define flume_release 1.3.1%{?dist}
...
%attr(0755,root,root) %{lib_flume}/bin/flume-ng.orig
%attr(0755,root,root) %{lib_flume}/bin/flume-ng.ps1
%attr(0755,root,root) %{lib_flume}/bin/flume-ng.cmd
%{lib_flume}/lib/*.jar
%{lib_flume}/tools/*.jar
%{lib_flume}/conf
