...
tar xvf  ${BUILD_DIR}/zeppelin-distribution/target/zeppelin-*.tar.gz  --strip-components=1 -C $PREFIX/$INSTALLATION_DIR
rm -rf $PREFIX/$INSTALLATION_DIR/run
ln -s  /var/run/zeppelin $PREFIX/$INSTALLATION_DIR/run
