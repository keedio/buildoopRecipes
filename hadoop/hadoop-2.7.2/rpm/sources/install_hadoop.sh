...
KMS_CONF=${KMS_CONF:-$PREFIX/etc/hadoop-kms/conf.dist}
...
#ln -sf /usr/lib/hadoop/hadoop-auth-2.6.1.jar $RPM_BUILD_ROOT/usr/lib/hadoop/hadoop-auth.jar || true
#ln -sf /usr/lib/hadoop/hadoop-common-2.6.1.jar $RPM_BUILD_ROOT/usr/lib/hadoop/hadoop-common.jar || true
...
gzip -c < $DISTRO_DIR/hdfs.1 > $MAN_DIR/man1/hdfs.1.gz
gzip -c < $DISTRO_DIR/mapred.1 > $MAN_DIR/man1/mapred.1.gz
gzip -c < $DISTRO_DIR/yarn.1 > $MAN_DIR/man1/yarn.1.gz
chmod 644 $MAN_DIR/man1/hadoop.1.gz
chmod 644 $MAN_DIR/man1/hdfs.1.gz
chmod 644 $MAN_DIR/man1/mapred.1.gz
chmod 644 $MAN_DIR/man1/yarn.1.gz

# KMS
install -d -m 0755 ${KMS_DIR}
install -d -m 0755 ${KMS_CONF}
install -d -m 0755 ${KMS_DIR}/sbin
install -d -m 0755 ${KMS_CONF}/tomcat-conf
cp -r ${BUILD_DIR}/share/hadoop/kms/tomcat/webapps ${KMS_DIR}
cp -r ${BUILD_DIR}/libexec/kms-config.sh ${KMS_DIR}
cp -r ${BUILD_DIR}/sbin/kms.sh ${KMS_DIR}/sbin/kms.sh
cp -r ${BUILD_DIR}/etc/hadoop/core-site.xml ${KMS_CONF}
cp -r ${BUILD_DIR}/etc/hadoop/kms-acls.xml ${KMS_CONF}
cp -r ${BUILD_DIR}/etc/hadoop/kms-env.sh ${KMS_CONF}
cp -r ${BUILD_DIR}/etc/hadoop/kms-log4j.properties ${KMS_CONF}
cp -r ${BUILD_DIR}/etc/hadoop/kms-site.xml ${KMS_CONF}
cp -r ${BUILD_DIR}/share/hadoop/kms/tomcat/conf/* ${KMS_CONF}/tomcat-conf
...
install -d -m 0755 $PREFIX/var/{log,run,lib}/hadoop-kms
install -d -m 0755 $PREFIX/var/run/hadoop-https
...
# sym links for Oozie
ln -s /usr/lib/hadoop/client/hadoop-annotations-${HADOOP_VERSION}.jar ${PREFIX}/usr/lib/hadoop/client/hadoop-annotations.jar
ln -s /usr/lib/hadoop/client/hadoop-auth-${HADOOP_VERSION}.jar ${PREFIX}/usr/lib/hadoop/client/hadoop-auth.jar
ln -s /usr/lib/hadoop/client/hadoop-common-${HADOOP_VERSION}.jar ${PREFIX}/usr/lib/hadoop/client/hadoop-common.jar
ln -s /usr/lib/hadoop/client/hadoop-mapreduce-client-app-${HADOOP_VERSION}.jar ${PREFIX}/usr/lib/hadoop/client/hadoop-mapreduce-client-app.jar
ln -s /usr/lib/hadoop/client/hadoop-mapreduce-client-common-${HADOOP_VERSION}.jar ${PREFIX}/usr/lib/hadoop/client/hadoop-mapreduce-client-common.jar
ln -s /usr/lib/hadoop/client/hadoop-hdfs-${HADOOP_VERSION}.jar ${PREFIX}/usr/lib/hadoop/client/hadoop-hdfs.jar
ln -s /usr/lib/hadoop/client/hadoop-mapreduce-client-core-${HADOOP_VERSION}.jar ${PREFIX}/usr/lib/hadoop/client/hadoop-mapreduce-client-core.jar
ln -s /usr/lib/hadoop/client/hadoop-mapreduce-client-jobclient-${HADOOP_VERSION}.jar ${PREFIX}/usr/lib/hadoop/client/hadoop-mapreduce-client-jobclient.jar
ln -s /usr/lib/hadoop/client/hadoop-mapreduce-client-shuffle-${HADOOP_VERSION}.jar ${PREFIX}/usr/lib/hadoop/client/hadoop-mapreduce-client-shuffle.jar
ln -s /usr/lib/hadoop/client/hadoop-yarn-api-${HADOOP_VERSION}.jar ${PREFIX}/usr/lib/hadoop/client/hadoop-yarn-api.jar
ln -s /usr/lib/hadoop/client/hadoop-yarn-client-${HADOOP_VERSION}.jar ${PREFIX}/usr/lib/hadoop/client/hadoop-yarn-client.jar
ln -s /usr/lib/hadoop/client/hadoop-yarn-common-${HADOOP_VERSION}.jar ${PREFIX}/usr/lib/hadoop/client/hadoop-yarn-common.jar
ln -s /usr/lib/hadoop/client/hadoop-yarn-server-common-${HADOOP_VERSION}.jar ${PREFIX}/usr/lib/hadoop/client/hadoop-yarn-server-common.jar
