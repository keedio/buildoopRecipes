...
ln -sf /usr/lib/hadoop/hadoop-auth-2.7.1.jar $RPM_BUILD_ROOT/usr/lib/hadoop/hadoop-auth.jar || true
ln -sf /usr/lib/hadoop/hadoop-common-2.7.1.jar $RPM_BUILD_ROOT/usr/lib/hadoop/hadoop-common.jar || true
